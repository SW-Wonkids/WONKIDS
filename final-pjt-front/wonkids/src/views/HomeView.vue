...
<template>
  <div class="koreanfont" style="margin-left: 55px; margin-right: 55px;">
    <RouterLink :to="{name: 'home'}"><img src="@/assets/wonkids.png" class="d-block w-100" style="max-width: 400px; height: auto; margin: auto; display: block; width: 60%"></RouterLink>
    <div class="container">
    <div id="carouselExampleCaptions" class="carousel slide" style="max-width: 800px">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="card carousel-caption d-none d-md-block">
