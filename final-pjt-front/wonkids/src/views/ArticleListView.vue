<template>
  <div class="background koreanfont" style="margin-left: 50px; margin-right: 50px;">
    <h1 style="color: aliceblue; font-size: 50px; text-decoration: underline;"><img src="@/assets/articletitle.png" style="width: 30%;"></h1>
    
    <div class="container">
    <p class="card-banner" style="font-size: 24px;text-align: center; width: 55%; margin-bottom: 50px;">
      나와 같은 포켓몬을 잡은 사람은 누구일까요? <br>궁금하다면 해당 <strong>카테고리를 선택</strong>하고 글을 써보세요!<br>
      아직 잡은 포켓몬이 없다면 이쪽으로 -> <RouterLink :to="{name: 'poll'}"><span style="font-size: 40px; color: yellow;">Click</span></RouterLink>
      </p>
    <p class="card-banner" style="font-size: 24px;text-align: center; width: 55%; margin-top: 0px;"><strong>게시글 작성 규칙</strong><br>
        <br>
        ...
        <button type="button" class="btn btn-light" style="margin-left: 33px;box-shadow: 0 4px 8px rgba(0, 0, 0, 0.9); width: 300px; height: 80px; margint ">
          <RouterLink :to="{name:'article-create'}" style="font-size: 40px;">게시글 생성</RouterLink>
        </button><br>
